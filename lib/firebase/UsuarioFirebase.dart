...
class UsuarioFirebase {
  ...
  Future<String?> pegarGerenteUid(String uidUsuario) async {
    if (uidUsuario == null) return null;
    final doc = await _usuariosRef.doc(uidUsuario).get();
    final data = doc.data() as Map<String, dynamic>?;
    return data?['gerenteUid'] as String?;
  }
